...
* Date custom fields (Settings -> Fields): filter by from/to date range instead of one exact date; toggle in the Filters panel customize UI (option meprmf_date_custom_fields_use_range, default on).
